...
const int MAX_SIZE = 244;  // this is the max number of elements
...
//Exception Classes
	class Overflow {};    //Overflow class if number of elements is out of queue's size
	class Underflow {};   //Underflow class if the front index is -1
